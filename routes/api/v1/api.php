...
Route::group(['namespace' => 'Api\V1', 'middleware' => 'localization'], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::post('verify-email-phone', 'CustomerAuthController@verify_email_phone');
        ...
        Route::post('forgot-password-change', 'PasswordResetController@reset_change_password_request');
        Route::post('new-reset-password', 'PasswordResetController@new_password_submit');
...
//            Route::post('/submit', 'DeliveryManReviewController@submit_review');
  ...
  Route::group(['prefix' => 'ads-banners'], function () {
        Route::get('/', 'BannerController@get_ads_banners');
    });
    ...
    Route::group(['prefix' => 'customer'], function () {
        ...
        Route::group(['namespace' => 'Auth'],function () {
            Route::post('remove-account', 'CustomerAuthController@remove_account');
        });
       ...
       Route::group(['prefix' =>'order'], function () {
            Route::get('list/{user_id}', 'OrderController@get_order_list');
