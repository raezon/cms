                ...
                <div class="navbar-vertical-content">
                                    ...
                                    <li class="nav-item {{ Request::is('admin/orders/list/pending') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.orders.list', ['pending']) }}"
                                            ...
                                            <span class="text-truncate sidebar--badge-container">
                                                ...
                                                <span class="badge badge-soft-info badge-pill ml-1">
                                                    {{ \App\Model\Order::notPos()->where(['order_status' => 'pending'])->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                        ...
                                        <a class="nav-link " href="{{ route('admin.orders.list', ['confirmed']) }}"
                                            ...
                                            <span class="text-truncate sidebar--badge-container">
                                                ...
                                                <span class="badge badge-soft-success badge-pill ml-1">
                                                    {{ \App\Model\Order::notPos()->where(['order_status' => 'confirmed'])->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                        ...
                                        <a class="nav-link " href="{{ route('admin.orders.list', ['processing']) }}"
                                            ...
                                            <span class="text-truncate sidebar--badge-container">
                                                ...
                                                <span class="badge badge-soft-warning badge-pill ml-1">
                                                    {{ \App\Model\Order::notPos()->where(['order_status' => 'processing'])->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    <li
                                        ...
                                        <a class="nav-link "
                                            ...
                                            <span class="text-truncate sidebar--badge-container">
                                                ...
                                                <span class="badge badge-soft-warning badge-pill ml-1">
                                                    {{ \App\Model\Order::notPos()->where(['order_status' => 'out_for_delivery'])->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                        ...
                                        <a class="nav-link " href="{{ route('admin.orders.list', ['returned']) }}"
                                            ...
                                            <span class="text-truncate sidebar--badge-container">
                                                ...
                                                <span class="badge badge-soft-danger badge-pill ml-1">
                                                    {{ \App\Model\Order::notPos()->where(['order_status' => 'returned'])->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{ Request::is('admin/orders/list/failed') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.orders.list', ['failed']) }}"
                                            ...
                                            <span class="text-truncate sidebar--badge-container">
                                                ...
                                                <span class="badge badge-soft-danger badge-pill ml-1">
                                                    {{ \App\Model\Order::notPos()->where(['order_status' => 'failed'])->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                        ...
                                        <a class="nav-link " href="{{ route('admin.orders.list', ['canceled']) }}"
                                            ...
                                            <span class="text-truncate sidebar--badge-container">
                                                ...
                                                <span class="badge badge-soft-dark badge-pill ml-1">
                                                    {{ \App\Model\Order::notPos()->where(['order_status' => 'canceled'])->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                 ...
                 {{--        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['order_management']))
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['product_management']))
                            ...
                            <!-- Pages -->
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/addon*') || Request::is('admin/product*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['user_management']))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/customer/transaction') || Request::is('admin/customer/list') || Request::is('admin/customer/view*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/customer/transaction') || Request::is('admin/customer/list') || Request::is('admin/customer/view*') ? 'block' : '' }}; top: 831.076px;">
                                    <li
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/customer/transaction') ? 'active' : '' }}">
                   ...
                   {{--      @if (Helpers::module_permission_check(MANAGEMENT_SECTION['table_management']))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/table/list') || Request::is('admin/promotion/create') || Request::is('admin/table/index') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:">
                                    <i class="tio-gift nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="top: 391.823px; display: {{ Request::is('admin/table*') || Request::is('admin/promotion/*') ? 'block' : '' }};">
