            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content text-capitalize">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle" title="{{ translate('Pages') }}">{{ translate('order') }}
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="nav-link "
                                        href="{{ route('branch.orders.list', ['out_for_delivery']) }}" title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate sidebar--badge-container">
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle">{{ translate('table') }} {{ translate('order') }}
                                {{ translate('section') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>

                  {{--       <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('branch/table/order/list/*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                <i class="tio-shopping-cart nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('branch/table/order/list/all') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('branch.table.order.list', ['all']) }}"
                                        title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate sidebar--badge-container">
                                            {{ translate('all') }}
                                ...
                                <li
                                    class="nav-item {{ Request::is('branch/table/order/list/confirmed') ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ Request::is('branch/table/order/list/done') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('branch.table.order.list', ['done']) }}"
                                        title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate sidebar--badge-container">
                                ...
                                <li
                                    class="nav-item {{ Request::is('branch/table/order/list/completed') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item {{ Request::is('branch/table/order/list/canceled') ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ Request::is('branch/table/order/running') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('branch.table.order.running') }}"
                                        title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate sidebar--badge-container">
                                            {{ translate('On Table') }}
