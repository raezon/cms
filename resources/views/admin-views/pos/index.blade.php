                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('admin.pos.customer-store')}}" method="post" id="customer-form">
                            ...
                            <div class="row pl-2">
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="f_name" class="form-control" value="" placeholder="Name" required="">
                                    </div>
                            ...
                            <div class="row pl-2">
                                  <input type="email" name="email" hidden class="form-control" value="admin@overdoseshawarma.com" placeholder="Ex : ex@example.com" required="">
                                <div class="col-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="l_name" class="form-control" value="" placeholder="Address" required="">
                                    </div>
                                </div>
